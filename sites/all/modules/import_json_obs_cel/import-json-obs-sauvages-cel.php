<?php
  ...
  foreach($array12Plantes as $nomScieEflore){
    // //$json = file_get_contents("http://www.tela-botanica.org/service:cel:CelWidgetMapPoint/tout?zoom=8&ne=45.12668|7.718706&sw=42.982239|4.230691&projet=sauvages&taxon=$nomScieEflore");
    ...
    $csv = file_get_contents("http://www.tela-botanica.org/service:cel:CelWidgetExport?format=csv&dept=13,83,05,84,04,06&projet=sauvages&colonnes=standard&num_taxon=$nomScieEflore");
